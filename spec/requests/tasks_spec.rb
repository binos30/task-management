...
RSpec.describe "/tasks", type: :request do
  ...
  let(:valid_attributes) { { title: 'Task', status: 'undone' } }
  ...
  describe "PATCH /update" do
    let!(:task) { create :task }
    let(:new_attributes) { { title: "Task2" } }

    context "with valid parameters" do
      it "updates the requested task" do
        expect { patch task_url(task), params: { task: new_attributes } }.to(
          change { task.reload.title }.to("Task2")
        )
      end
